        ...
        case SELLER_PRODUCT_CATALOG:
            {
                ...
                let currPage = Math.floor((parseInt(action.payload.data.displayResultsOffset) +50 )/50 );
                ...
                //   let  pageCount = totalCOunt / state.productsPerPage? Math.floor((totalCOunt / state.productsPerPage) )+1 : 1// totalCOunt % state.productsPerPage ? Math.floor((totalCOunt / state.productsPerPage) + 1) : totalCOunt / state.productsPerPage ;
